...
(function($) {
    ...
    var BulkTracker = {
        ...
        hideFieldSelectionModal: function() {
            $('#build360-ai-field-select-modal').css('display', 'none');
        },
        ...
        showReviewModal: function() {
            this.reviewPage = 1;
            $('#build360-ai-bulk-review-modal').css({display: 'flex', alignItems: 'center', justifyContent: 'center'});
            this.loadReviewPage();
        },

        hideReviewModal: function() {
            $('#build360-ai-bulk-review-modal').css('display', 'none');
        },
